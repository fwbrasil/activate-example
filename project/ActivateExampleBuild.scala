...
object ActivateExampleBuild extends Build {
	...
	val activatePrevayler = "net.fwbrasil" %% "activate-prevayler" % "1.0-RC4"
	val activateJdbc = "net.fwbrasil" %% "activate-jdbc" % "1.0-RC4"
	val activateMongo = "net.fwbrasil" %% "activate-mongo" % "1.0-RC4"
